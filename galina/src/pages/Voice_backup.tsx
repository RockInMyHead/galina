  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <p className="text-muted-foreground mb-8">Нажмите кнопку микрофона для начала записи</p>

        <div className="flex flex-col items-center space-y-6">
          {/* Простой круглый орб */}
          <div className="w-48 h-48 rounded-full bg-primary/10 border-4 border-primary/20 flex items-center justify-center">
            <div className={`w-32 h-32 rounded-full ${isRecording ? 'bg-red-500' : 'bg-primary'} transition-colors duration-300 flex items-center justify-center`}>
              <Mic className={`w-12 h-12 ${isRecording ? 'text-white' : 'text-primary-foreground'}`} />
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-xl font-medium">
              {isRecording ? '🎤 Запись...' : 'Готов к разговору'}
            </p>
          </div>
