...
const Documents = () => {
  const documentServices = [
    ...
    },
    {
      ...
      color: "bg-[#129246]/10 text-[#129246]",
    },
  ];
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {documentServices.map((service, index) => (
                <Link key={index} to={service.href} className="group block h-full no-underline">
                  <Card className="h-full border-border/50 shadow-elegant transition-smooth hover:shadow-glow hover:border-primary/50 cursor-pointer">
                    <CardHeader className="text-center pb-4">
                      <div className="flex justify-center mb-4">
                        <div className={`flex h-12 w-12 items-center justify-center rounded-full ${service.color} transition-smooth group-hover:brightness-110`}>
