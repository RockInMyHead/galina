...
Пожалуйста, задай мне вопросы для заполнения всех необходимых полей этого документа.
Будь подробным и задавай вопросы по порядку, начиная с основных данных сторон.`
    );
